...
mapping_file = "scripts/resources/mapping_features_keys.csv" # Ruta del archivo de mapeo
model_path = "variability_model/KubernetesFM_simple.uvl" # Ruta del modelo de características
